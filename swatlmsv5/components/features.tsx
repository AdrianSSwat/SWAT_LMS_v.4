    ...
    <div className="relative p-6 md:p-16">
      ...
      <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
        <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
          ...
          SWAT Learning Management System.
          </h2>
          {/* Tab Navs */}
          <nav
              ...
              <span className="flex">
                ...
                <span className="grow ms-6">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                   Course content effortlessly, ensuring flexibility and relevance in teaching materials.
                  </span>
                </span>
              </span>
            </button>
            ...
            >
              <span className="flex">
                ...
                <span className="grow ms-6">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                   Educational technologies and systems to optimize workflow and minimize administrative overhead.
                  </span>
                </span>
              </span>
            </button>
            ...
            >
              <span className="flex">
                ...
                <span className="grow ms-6">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                   Responsive mobile interface, promoting anytime, anywhere learning.
                  </span>
                </span>
              </span>
            </button>
